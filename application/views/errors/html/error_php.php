...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/css/pages/page-404.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="<?php echo site_url(); ?>assets/pc/images/gallery/error-2.png" class="bg-image-404" alt="">
      <h1 class="error-code m-0">404</h1>
      <h6 class="mb-2">BAD REQUEST</h6>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="<?php echo site_url(); ?>Pc">Back
        TO Home</a>
    </div>
  </div>
</div>
