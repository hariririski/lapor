...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/data-tables/css/jquery.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/data-tables/extensions/responsive/css/responsive.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/data-tables/css/dataTables.checkboxes.css">
    <!-- END: VENDOR CSS-->
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo site_url(); ?>Lapor/detail_pengaduan/<?php echo $pengaduan->id_pengaduan; ?>"><button type="button" class="btn btn-primary">Detail</button></a></td>
...
<!--/ Theme Customizer -->
    ...
    <script src="<?php echo site_url(); ?>assets/pc/vendors/data-tables/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/vendors/data-tables/extensions/responsive/js/dataTables.responsive.min.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/vendors/data-tables/js/datatables.checkboxes.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
