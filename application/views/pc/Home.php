...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/animate-css/animate.css">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/chartist-js/chartist.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/vendors/chartist-js/chartist-plugin-tooltip.css">
    <!-- END: VENDOR CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/css/pages/dashboard-modern.css">
    <link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>assets/pc/css/pages/intro.min.css">
    <!-- END: Page Level CSS-->
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
   ...
   <div class="row vertical-modern-dashboard">
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Jumlah Pengaduan <i
                     class="material-icons float-right">more_vert</i>
               </h6>
               <p class="medium-small">Jumlah Pengaduan</p>
      ...
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Pengaduan Selesai <i
                     class="material-icons float-right">more_vert</i>
               </h6>
               <p class="medium-small">Jumlah Pengaduan</p>
               <div class="current-balance-container">
      ...
      <div class="col s12 m4 l4">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content">
               <h6 class="mb-0 mt-0 display-flex justify-content-between">Pengaduan Sedang di Proses <i
                     class="material-icons float-right">more_vert</i>
               </h6>
               <p class="medium-small">Jumlah Pengaduan</p>
               <div class="current-balance-container">
...
>
    ...
    <script src="<?php echo site_url(); ?>assets/pc/vendors/chartjs/chart.min.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/vendors/chartist-js/chartist.min.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/vendors/chartist-js/chartist-plugin-tooltip.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/vendors/chartist-js/chartist-plugin-fill-donut.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?php echo site_url(); ?>assets/pc/js/scripts/dashboard-modern.js"></script>
    <script src="<?php echo site_url(); ?>assets/pc/js/scripts/intro.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
